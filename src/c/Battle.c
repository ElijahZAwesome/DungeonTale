...
MenuDefinition battleMainMenuDef = 
{
	.menuEntries = 
	{
		{"Fight", "Attack with your knife.", AttackCurrentMonster},
		{"Act/Item", "Act or use an item", ShowItemBattleMenu},
		{NULL, NULL, NULL},
		{"Stat", "Character advancement", ShowProgressMenu},
		{NULL, NULL, NULL},
		{"Mercy", "Try to Spare", AttemptToRun},
	},
...
MenuDefinition itemBattleMenuDef = 
{
	.menuEntries = 
	{
		...
		{"Eat", "Heal 50% of your HP", ActivateCombatPotion},
		{"Eat", "Heal 100% of your HP", ActivateCombatFullPotion},
		{"Act", "Talk to monster", ActivateFireScroll},
		{"Act", "Flirt with monster", ActivateIceScroll},
		{"Act", "Be nice to monster", ActivateLightningScroll}
	},
